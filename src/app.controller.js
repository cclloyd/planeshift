...
var AppController = function () {
    ...
    var _getWorld_decorators;
    var AppController = _classThis = /** @class */ (function () {
        function AppController_1(appService, browser) {
        ...
        AppController_1.prototype.getHello = function () {
            return __awaiter(this, void 0, void 0, function () {
                var instance, foundryGame;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log(fvtt);
                            return [4 /*yield*/, this.browser.getInstance()];
                        case 1:
                            instance = _a.sent();
                            return [4 /*yield*/, instance.runFoundry(function () {
                                    return game;
                                })];
                        case 2:
                            foundryGame = (_a.sent());
                            return [2 /*return*/, foundryGame];
                    }
                });
            });
        };
        AppController_1.prototype.getWorld = function () {
            return __awaiter(this, void 0, void 0, function () {
                var instance, world;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.browser.getInstance()];
                        case 1:
                            instance = _a.sent();
                            return [4 /*yield*/, instance.runFoundry(function () {
                                    return game.world;
    ...
    (function () {
        ...
        _getWorld_decorators = [(0, common_1.Get)('world')];
        ...
        __esDecorate(_classThis, null, _getWorld_decorators, { kind: "method", name: "getWorld", static: false, private: false, access: { has: function (obj) { return "getWorld" in obj; }, get: function (obj) { return obj.getWorld; } }, metadata: _metadata }, null, _instanceExtraInitializers);
